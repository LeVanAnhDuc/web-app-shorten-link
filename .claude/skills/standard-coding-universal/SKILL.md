...
- Class/type names must be nouns: `LinksService`, `RedirectController`, `ShortenResult`
...
- **No string concatenation for queries** — always use parameterized queries or an ORM (Prisma)
